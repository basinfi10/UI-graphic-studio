...
const panels: { id: Panel; label: string; icon: string }[] = [
  {id:'background',label:'배경',icon:'▨'}, {id:'shapes',label:'도형',icon:'▭'}, {id:'icons',label:'아이콘',icon:'✦'}, {id:'iconStudio',label:'아이콘 제작',icon:'🖌'}, {id:'samples',label:'샘플 UI',icon:'▣'}, {id:'components',label:'컴포넌트',icon:'▤'}, {id:'styles',label:'스타일 프리셋',icon:'◐'}, {id:'tokens',label:'디자인 토큰',icon:'🎨'}, {id:'layout',label:'정렬 / 분배',icon:'⇄'}, {id:'layers',label:'레이어',icon:'☰'}, {id:'props',label:'속성',icon:'⚙'}, {id:'canvas',label:'캔버스 / 그리드',icon:'▥'}, {id:'code',label:'코드 Export',icon:'</>'}
];
